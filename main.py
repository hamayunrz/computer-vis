...
class Countdown():
    ...
    def draw_timer(self):
        ...
        # draw current timer value (bottom right)
    ...
    def spawn_target(self):
        # only spawn while timer is running and if no target is on screen
    ...
    # update timer / targets / aimbot every frame
    def update(self):
        self.cooldowns()
